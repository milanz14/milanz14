    ...
    <section id="projects">
      <div className="max-w-6xl px-5 mx-auto mt-32 text-center">
        ...
        {projectData.map((project) => (
          <div className="mt-12 md:space-x-2">
            {/* Project 1 */}
            <div className="flex flex-col items-center p-6 space-y-6 rounded-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-800">
              <img
